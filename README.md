...
| VISA PVV: generate then verify (full chain) | [open →](https://cyberchef.jacobmarks.com/#recipe=Comment('VISA%20PVV%20generate%20then%20verify')PIN_Generate(4,'PIN%20digits','')Register('(%5B%5C%5Cs%5C%5CS%5D*)',true,false,false)VISA_PVV_Generate('0123456789ABCDEFFEDCBA9876543210','5432101234567890',1,false)VISA_PVV_Verify('0123456789ABCDEFFEDCBA9876543210','5432101234567890',1,'$R0',true)) |
...
| IBM 3624: generate then verify (full chain) | [open →](https://cyberchef.jacobmarks.com/#recipe=Comment('IBM%203624%20generate%20then%20verify')PIN_Generate(4,'PIN%20digits','')Register('(%5B%5C%5Cs%5C%5CS%5D*)',true,false,false)PIN_IBM_3624_Offset_Generate('0123456789ABCDEFFEDCBA9876543210','0123456789012345','5432101234567890','F',false)PIN_IBM_3624_Verify('0123456789ABCDEFFEDCBA9876543210','0123456789012345','5432101234567890','F','$R0',true)) |
...
| Recipe | Link |
|---|---|
| AES DUKPT: derive IK from BDK | [open →](https://cyberchef.jacobmarks.com/#recipe=Comment('AES%20DUKPT%20derive%20IK%20from%20BDK')Key_Generate('AES-128%20(16%20bytes)',16,true,false)DUKPT_Derive_AES_Key('BDK','Initial%20Key%20%28IK%29','123456789012345600000001','PIN%20Encryption',true)) |
| AES DUKPT: derive working key — PIN encryption | [open →](https://cyberchef.jacobmarks.com/#recipe=Comment('AES%20DUKPT%20derive%20working%20key%20-%20PIN%20encryption')Key_Generate('AES-128%20(16%20bytes)',16,true,false)DUKPT_Derive_AES_Key('BDK','Working%20Key','123456789012345600000001','PIN%20Encryption',true)) |
| AES DUKPT: derive working key — MAC generation | [open →](https://cyberchef.jacobmarks.com/#recipe=Comment('AES%20DUKPT%20derive%20working%20key%20-%20MAC%20generation')Key_Generate('AES-128%20(16%20bytes)',16,true,false)DUKPT_Derive_AES_Key('BDK','Working%20Key','123456789012345600000001','MAC%20Generation',true)) |
...
|---|---|---|
| Brand test card setup | `PAN Generate` → `PAN Parse` | [open →](https://cyberchef.jacobmarks.com/#recipe=Comment('Brand%20test%20card%20setup')PAN_Generate('Visa','Curated%20sample',16,'Any',false)PAN_Parse()) |
...
| AES DUKPT: BDK → IK → working key | `Key Generate` → `DUKPT Derive AES Key` | [open →](https://cyberchef.jacobmarks.com/#recipe=Comment('AES%20DUKPT%20BDK%20to%20IK%20to%20working%20key')Key_Generate('AES-128%20(16%20bytes)',16,true,false)DUKPT_Derive_AES_Key('BDK','Working%20Key','123456789012345600000001','PIN%20Encryption',true)) |
...
| [J8k3/aws-payment-cryptography-mcp](https://github.com/J8k3/aws-payment-cryptography-mcp) | Cloud — APC MCP server for AWS Payment Cryptography automation and analysis |
